...
const ru = {
  ...
  mapFallbackDemo: "В демо нет ключа картографического провайдера, поэтому маршруты нарисованы схематично.",
...
const en: typeof ru = {
  ...
  mapFallbackDemo: "The demo ships no map provider key, so routes are drawn schematically.",
