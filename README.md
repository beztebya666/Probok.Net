...
<sub>Демо работает целиком в браузере на фиксированных данных: боевые запросы к API выключены,
ключей в нём нет.</sub>
...
> Скриншоты и клипы сняты в демо-режиме (в шапке видна плашка «Демо-данные»): цвета участков
> здесь — фиксированный синтетический набор, геометрия дорог настоящая, карта настоящая.
