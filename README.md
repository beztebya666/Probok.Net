...
Один и тот же путь, два ответа:

| | Обычный навигатор | Пробок.Нет |
|---|---|---|
| Время | **42 мин** | 53 мин |
| Расстояние | 18,5 км | 32 км |
| **Стоим в красном** | **21 мин** | **0 мин** |
| Оранжевые участки | 7 мин | 6 мин |
| Доля пути без заметной задержки | 25 % | **80 %** |

Навигатор экономит 11 минут и отдаёт за них 21 минуту стояния. Пробок.Нет делает
крюк в 13,5 км вокруг затора — и едет всю дорогу.

<img src="docs/media/detour.webp" width="100%" alt="Зелёный маршрут обходит затор: серая линия навигатора идёт напрямую через красный коридор, зелёная — в объезд">

Серая линия — прямой путь через центр, тот самый с 21 минутой красного. Зелёная —
что нашёл поиск: длиннее, севернее, мимо затора.
